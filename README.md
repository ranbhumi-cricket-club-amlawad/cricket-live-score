...
- Match status changes, make-live actions, second-innings start, cancellations, and every remove action require confirmation in a popup before continuing
...
- A sticky compact score preview for live, pre-live, and innings-break matches shows the current runs, wickets, over, ball, striker, and non-striker; it wraps on mobile
- Recent balls
- Upcoming matches
...
- `publicIndex`: generated public date index for loading upcoming/completed matches by selected date.
