...
export function AdminPage() {
  ...
  const showAdminLiveSummary = ["LIVE", "PRE LIVE", "INNINGS BREAK"].includes(String(match.status || "").toUpperCase());
  ...
  return (
    <main className="admin-shell">
      ...
      {showAdminLiveSummary ? <div className="admin-live-summary" aria-label="Current live score summary">
